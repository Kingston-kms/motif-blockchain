...
import (
	...
	"github.com/motifd/motif-blockchain/utils/iodb"
	"github.com/motifd/motif-blockchain/utils/ioread"
)
...
func importEvents(ctx *cli.Context) error {
	...
	genesis := getMotifGenesis(ctx)
	cfg := makeAllConfigs(ctx)
	cfg.Motif.Protocol.EventsSemaphoreLimit.Size = math.MaxUint32
	cfg.Motif.Protocol.EventsSemaphoreLimit.Num = math.MaxUint32
	cfg.Motif.Emitter.Validator = emitter.ValidatorConfig{}
	cfg.Motif.TxPool.Journal = ""
	cfg.Node.IPCPath = ""
	cfg.Node.HTTPHost = ""
	cfg.Node.WSHost = ""
	cfg.Node.NoUSB = true
