...
motif:
	...
	go build \
	    -ldflags "-s -w -X github.com/motifd/motif-blockchain/cmd/motif/launcher.gitCommit=$${GIT_COMMIT} -X github.com/motifd/motif-blockchain/cmd/motif/launcher.gitDate=$${GIT_DATE}" \
	    -o build/motif \
	    ./cmd/motif
