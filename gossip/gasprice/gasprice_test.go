...
func (t TestBackend) GetRules() motif.Rules {
	return t.rules
}

func (t TestBackend) GetPendingRules() motif.Rules {
...
func TestSuggestPrice(t *testing.T) {
	backend := &TestBackend{
		block:             1,
		totalGasPowerLeft: 0,
		rules:             motif.FakeNetRules(),
		pendingRules:      motif.FakeNetRules(),
	}
