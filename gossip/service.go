...
import (
	...
	"github.com/motifd/motif-blockchain/ethapi"
	"github.com/motifd/motif-blockchain/eventcheck"
	...
	"github.com/motifd/motif-blockchain/gossip/blockproc/drivermodule"
	"github.com/motifd/motif-blockchain/gossip/blockproc/eventmodule"
	"github.com/motifd/motif-blockchain/gossip/blockproc/evmmodule"
	"github.com/motifd/motif-blockchain/gossip/blockproc/sealmodule"
	"github.com/motifd/motif-blockchain/gossip/blockproc/verwatcher"
	"github.com/motifd/motif-blockchain/gossip/emitter"
	"github.com/motifd/motif-blockchain/gossip/filters"
	...
	"github.com/motifd/motif-blockchain/utils/wgmutex"
...
func DefaultBlockProc(g motif.Genesis) BlockProc {
	return BlockProc{
...
// MakeProtocols constructs the P2P protocol definitions for `motif`.
...
func (s *Service) Stop() error {
	defer log.Info("Motif service stopped")
	s.verWatcher.Stop()
	close(s.done)
	s.emitter.Stop()
	s.pm.Stop()
