...
import (
	...
	"github.com/motifd/motif-blockchain/motif/genesis/driver/drivercall"
	"github.com/motifd/motif-blockchain/motif/genesis/driver/driverpos"
	...
	netinitcall "github.com/motifd/motif-blockchain/motif/genesis/netinit/netinitcalls"
...
func NewDriverTxGenesisTransactor(g motif.Genesis) *DriverTxGenesisTransactor {
...
func (p *DriverTxListener) OnNewLog(l *types.Log) {
	...
	if l.Topics[0] == driverpos.Topics.UpdateNetworkRules && len(l.Data) >= 64 {
		...
		p.bs.DirtyRules, err = motif.UpdateRules(p.bs.DirtyRules, diff)
		if err != nil {
