...
import (
	...
	"github.com/motifd/motif-blockchain/gossip/evmstore"
	"github.com/motifd/motif-blockchain/gossip/sfcapi"
	"github.com/motifd/motif-blockchain/inter"
	"github.com/motifd/motif-blockchain/inter/drivertype"
	"github.com/motifd/motif-blockchain/motif"
	"github.com/motifd/motif-blockchain/motif/genesis"
)

// ApplyGenesis writes initial state.
func (s *Store) ApplyGenesis(blockProc BlockProc, g motif.Genesis) (genesisHash hash.Hash, err error) {
...
func (s *Store) applyEpoch0Genesis(g motif.Genesis) (evmBlock *evmcore.EvmBlock, err error) {
...
func (s *Store) applyEpoch1Genesis(blockProc BlockProc, g motif.Genesis) (err error) {
	...
	prettyHash := func(root common.Hash, g motif.Genesis) hash.Event {
