...
type Reader interface {
	base.Reader
	GetEpochRules() (motif.Rules, idx.Epoch)
}
...
func CalcGasPowerUsed(e inter.EventPayloadI, rules motif.Rules) uint64 {
	txsGas := uint64(0)
...
func (v *Checker) checkGas(e inter.EventPayloadI, rules motif.Rules) error {
...
func CheckTxs(txs types.Transactions, rules motif.Rules) error {
	maxType := uint8(0)
